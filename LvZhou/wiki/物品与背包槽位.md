...
槽位的解锁需要通过脚本侧调用相应的API实现，其中物品槽位的解锁调用 [[api/class/detail/和平全局接口/物品与背包/UGCItemSystemV2|``SetEquipSlotEnable``]]，背包槽位的解锁调用 [[api/class/detail/和平全局接口/物品与背包/UGCBackpackSystemV2|``SetEquipSlotEnable``]]。
...
|函数库/类名|函数类型|函数功能范围|
|-|-|-|
|[[api/class/detail/和平全局接口/物品与背包/UGCItemSystemV2|``SetEquipSlotEnable``]]|静态函数|解锁物品槽位|
|[[api/class/detail/和平全局接口/物品与背包/UGCItemSystemV2|``GetEquipSlotEnable``]]|静态函数|查询物品槽位状态|
|[[api/class/detail/和平全局接口/物品与背包/UGCBackpackSystemV2|``SetEquipSlotEnable``]]|静态函数|解锁背包槽位|
|[[api/class/detail/和平全局接口/物品与背包/UGCBackpackSystemV2|``GetEquipSlotEnable``]]|静态函数|查询背包槽位状态|
