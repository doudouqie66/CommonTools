...
在选中技能的情况下，点击【移除技能】按钮可以移除该技能，效果等同于 [[api/class/detail/和平全局接口/技能系统/UGCPersistEffectSystem|``RemoveSkillInstance``]]。
...
在目标对象的Buff栏，选中Buff并点击【移除Buff】按钮即可移除该Buff，效果等同于 [[api/class/detail/和平全局接口/技能系统/UGCPersistEffectSystem|``RemoveBuffByClass``]]。
