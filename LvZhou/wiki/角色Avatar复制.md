...
|方法|生效范围|适用场景|
|:-:|:-:|-|
|[[api/class/detail/Others/UGCCharAvatarShowcaseActor|ClientShowAvatar]]|客户端|适用于小场景展示，确保需展示的角色在当前客户端视野范围内且未被剔除|
|[[api/class/detail/Others/UGCCharAvatarShowcaseActor|ServerShowAvatar]]|服务器|适用于大场景展示，可确保所有客户端都能看到Avatar展示，需展示的角色不受视野限制|
...
[[api/class/detail/Others/UGCCharAvatarShowcaseActor|PlayAnim]] 方法可控制Avatar展示Actor循环播放或停止指定动画。以下为使用示例，界面设计如下：
