...
|------|------|-------------|
| Density | float | Density - 0.0 < 0.85 < 1.0 - Coloration of the late reverb - lower value is more |
| Diffusion | float | Diffusion - 0.0 < 0.85 < 1.0 - Echo density in the reverberation decay - lower i |
